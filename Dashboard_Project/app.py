...
# 'background': 'url(https://www.incomeinvestors.com/wp-content/uploads/2019/06/This-Dividend-Stock-Could-Be-the-Next-Berkshire-Hathaway-Inc..jpg)'},
...
app.layout = html.Div(style={
    ...
    html.Div(children=[
        html.Div(style={'textAlign': 'center', 'margin': '0 auto', 'margin-top': 20}, children=[
            ...
            dcc.Input(style={'margin-left': 50}, id='input', value='', type='text'),
        ...
        html.Div(style={'textAlign': 'center', 'margin': '0 auto', 'margin-top': 20}, children=[
            dcc.Tabs(id="tabs-example", value='tab-1-example', children=[
                dcc.Tab([
                    html.Div(style={'margin-top': 20}, id='stock_stats')], label='Financial Stats'),
                dcc.Tab([
                    html.Div(style={'margin-top': 20}, id='top_5_stock_links')], label='Top 5 Articles'),
                dcc.Tab([
                    '''
                Twitter sentiment of topic:
                    ''',
                    dcc.Input(style={'margin-top': 20}, id='input1', value='', type='text'),
                ...
                ], label='Twitter Sentiment Search'),
            ], colors={
                "border": "goldenrod",
                "primary": "gold",
